...
namespace RMAP_tolmach
{
    static class Crc
    {
        public static BitArray polinom { get; set; }
        public static BitArray bits { get; set; }
        ...
        static Crc()
        {
            bool[] myBools = new bool[9] { true, true, true, false, false, false, false, false, true };
